 ...
 */
internal class RenderLivingEventHook : Hook("net/minecraft/client/renderer/entity/RenderLivingBase") {

    /**
     * Inserts a call to [RenderLivingEvent.Pre]'s constructor at the head of
     * [net.minecraft.client.renderer.entity.RenderLivingBase.doRender], which
