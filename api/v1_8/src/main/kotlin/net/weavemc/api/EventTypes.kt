 ...
 * Therefore, [ShutdownEvent] is called by the [net.weavemc.api.event.EventBus] only in the event that
...
sealed class WorldEvent(val world: World) : Event() {
     ...
     * Therefore, [WorldEvent.Load] is called by the [net.weavemc.api.event.EventBus] only in the event
     ...
     * Therefore, [WorldEvent.Unload] is called by the [net.weavemc.api.event.EventBus] only in the event
